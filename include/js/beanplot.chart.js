(function($) {
  Drupal.behaviors.analyzedPhenotypesBeanplot = {
    attach: function (context, settings) {

      // Only do something if we have enough information from Drupal/PHP
      if (Drupal.settings.hasOwnProperty('analyzedPhenotypes')) {
        ...
        // The name of the germplasm to highlight.
        var germplasm =  Drupal.settings.analyzedPhenotypes.beanplot.germplasm;
        // The name of the trait the data represents.
        ...
        }); // End of retrieve dataset from [yoursite]/json/phenotypes/beanplot/[project_id]/[trait_id]
      } // End of if Drupal.settings
